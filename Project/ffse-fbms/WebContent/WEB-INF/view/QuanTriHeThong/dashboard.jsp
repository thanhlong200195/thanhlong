				...
				<div class="col-xs-12">
					<div class="card">
						<div class="col-md-3 dash-board-item">
							...
							<div><spring:message code="label.QuanTriHeThong_PhongBan" /></div>
						</div>
						<div class="col-md-3 dash-board-item">
							<a
							...
							<div><spring:message code="label.QuanTriHeThong_ChucDanh" /></div>
						</div>
						<div class="col-md-3 dash-board-item">
							...
							<div><spring:message code="label.QuanTriHeThong_TaiKhoan" /></div>
						</div>
						<div class="col-md-3 dash-board-item">
							...
							<div><spring:message code="label.QuanTriHeThong_PhanQuyenBoSung" /></div>
						</div>
					</div>
				</div>
			</div>
