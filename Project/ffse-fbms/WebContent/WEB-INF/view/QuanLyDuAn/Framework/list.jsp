...
<div class="app-content content container-fluid">
	...
	<div class="content-header-left col-md-9 col-xs-12 mb-2">
			...
			<table class="table">
				...
				<tbody>
					<c:forEach var="entities" items="${list}">
						<tr>
							<td>${entities.ma_framework}</td>
							<td>${entities.ten_framework}</td>
							<td><a
								href="/ffse-fbms/qlda/Framework/edit/${entities.ma_framework}"
								data-toggle="tooltip" title="edit">
									<button type="button" class="btn btn-icon btn-outline-warning">
										<i class="fa fa-pencil"></i>
									</button>
							</a> <a href="/ffse-fbms/qlda/Framework/delete/${entities.ma_framework}">
									<button type="button"
		...
		<div class="col-sm-4">
			<h5>
				<a href="/ffse-fbms/qlda/Framework/add_form"><strong>THÊM
						FRAMEWORK</strong></a>
			</h5>
