...
--
-- Host: localhost
-- Generation Time: Sep 17, 2018 at 08:04 AM
...
CREATE TABLE IF NOT EXISTS `cong_nghe` (
  ...
  `is_delete` varchar(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
--
-- Dumping data for table `cong_nghe_du_an`
--

INSERT INTO `cong_nghe_du_an` (`ma_du_an`, `ma_cong_nghe`) VALUES
(1, 'CN1');
...
('DB01', 'OrdacleUpdate1', 0),
('DB02', 'MySQL', 0),
('DB09', 'LQMOBI', 1),
('DT02', 'MySQL', 1),
('DT022', 'OrdacleUpdate22', 1),
('DT88', 'OrdacleUpdate', 1);
