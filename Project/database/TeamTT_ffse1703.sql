...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2018 at 06:33 PM
...
CREATE TABLE `hop_dong` (
  ...
  `ma_chuc_danh` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `hop_dong` (`ma_hop_dong`, `ma_nhan_vien`, `ma_loai_hop_dong`, `ma_chuc_danh`, `luong_thang_13`, `so_ngay_phep`, `ngay_ky`, `hop_dong_tu_ngay`, `hop_dong_den_ngay`, `trang_thai`) VALUES
(00001, 00001, 2, 'PGD', 1, 12, '2018-09-04', '2018-09-06', '2018-09-27', 1),
(00002, 00002, 1, 'PGD', 1, 12, '2018-09-04', '2018-09-19', '2018-09-28', 2);
...
CREATE TABLE `ho_so_nhan_vien_tt` (
  ...
  `thanh_pho` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `quan` varchar(250) COLLATE utf8_unicode_ci NOT NULL,
  `phuong` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `ma_dan_toc` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `ma_quoc_tich` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `so_dien_thoai` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
  `email` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
  `so_cmnd` varchar(11) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `ho_so_nhan_vien_tt` (`ma_nhan_vien`, `ma_phong_ban`, `ma_chuc_danh`, `ten_nhan_vien`, `anh_dai_dien`, `nam_sinh`, `gioi_tinh`, `ma_tinh_trang_hon_nhan`, `dia_chi`, `thanh_pho`, `quan`, `phuong`, `ma_dan_toc`, `ma_quoc_tich`, `so_dien_thoai`, `email`, `so_cmnd`, `noi_cap`, `ngay_cap`, `trang_thai`) VALUES
(00001, 'PGD', 'GD', 'Trần Thị Tâm', '1219820798006.png', '1999-04-02', 1, 1, '', '', '', '0', 'Kinh', 'VN', '01656947165', 'tranthitam@gmail.com', '206262821', 'Đà Nẵng', '2016-05-25', 1);
...
INSERT INTO `thong_tin_bang_cap` (`id`, `ma_nhan_vien`, `ten_bang_cap`, `loai_bang_cap`, `don_vi_cap`, `noi_cap`, `ngay_cap`) VALUES
(1, 00201, 'Cử nhân công nghệ thông tin', 'Khá', 'Cao đẳng công nghệ thông tin', 'Đà Nẵng', '2016-06-20'),
(2, 00202, 'Cử nhân kinh doanh', 'Giỏi', 'Đại Học Duy Tân', 'Đà Nẵng', '2018-09-10');
...
INSERT INTO `thong_tin_gia_dinh` (`id`, `ma_nhan_vien`, `ten`, `que_quan`, `nam_sinh`, `gioi_tinh`, `so_dien_thoai`, `quan_he`) VALUES
(1, 00001, 'Trần Văn', 'Đà Nẵng', '1992-05-07', 1, '01266676809', 'Anh');
