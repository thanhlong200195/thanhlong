...
--
-- Host: localhost
-- Generation Time: Oct 02, 2018 at 04:09 PM
...
--
-- Table structure for table `ffse1703004_users`
--

CREATE TABLE IF NOT EXISTS `ffse1703004_users` (
  `id` int(11) NOT NULL,
  `user_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `user_fullname` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `user_email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `user_password` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `user_image` varchar(100) CHARACTER SET latin1 NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ffse1703004_users`
--

INSERT INTO `ffse1703004_users` (`id`, `user_name`, `user_fullname`, `user_email`, `user_password`, `user_image`) VALUES
(1, 'admin', 'nguyen thanh long', 'ffse1703004@email.com', '123456', '');
...
--
-- Table structure for table `ly_do_xin_nghi`
--

CREATE TABLE IF NOT EXISTS `ly_do_xin_nghi` (
  `id` int(10) NOT NULL,
  `ly_do` varchar(30) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ly_do_xin_nghi`
--

INSERT INTO `ly_do_xin_nghi` (`id`, `ly_do`) VALUES
(1, 'Nghỉ phép năm'),
(2, 'Nghỉ thai sản'),
(3, 'Nghỉ ốm'),
(4, 'Nghỉ phép riêng');
...
--
-- Table structure for table `ngay_nghi`
--

CREATE TABLE IF NOT EXISTS `ngay_nghi` (
  `ma_nhan_vien` int(5) unsigned zerofill NOT NULL,
  `so_ngay_da_nghi` int(5) NOT NULL,
  `so_ngay_con_lai` int(5) NOT NULL,
  `ten_nhan_vien` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `ngay_nghi`
--

INSERT INTO `ngay_nghi` (`ma_nhan_vien`, `so_ngay_da_nghi`, `so_ngay_con_lai`, `ten_nhan_vien`) VALUES
(00001, 6, 6, 'Đặng Văn'),
(00002, 4, 8, 'Thái Nguyễn Thục'),
(00003, 5, 7, 'Trương Thành'),
(00004, 3, 9, 'Hoàng Phi'),
(00005, 3, 9, 'Trương Hữu'),
(00006, 3, 9, 'Đoàn Thị');
...
CREATE TABLE IF NOT EXISTS `sinhvien` (
  ...
  `tuoisv` varchar(4) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `sinhvien` (`masv`, `tensv`, `tuoisv`, `lop`) VALUES
(1, '1', '1', 'FFSE1701'),
(2, 'THANH LONG', '24', 'FFSE1702');

-- --------------------------------------------------------

--
-- Table structure for table `thong_ke_don_xin_phep`
--

CREATE TABLE IF NOT EXISTS `thong_ke_don_xin_phep` (
  `id` int(100) NOT NULL,
  `ma_nhan_vien` int(5) unsigned zerofill NOT NULL,
  `ngay_bat_dau` date NOT NULL,
  `ngay_ket_thuc` date NOT NULL,
  `so_ngay_nghi` int(20) NOT NULL,
  `ly_do` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ghi_chu` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `ghi_chu_truong_phong` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `trang_thai` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ten_nhan_vien` varchar(50) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=79 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `thong_ke_don_xin_phep`
--

INSERT INTO `thong_ke_don_xin_phep` (`id`, `ma_nhan_vien`, `ngay_bat_dau`, `ngay_ket_thuc`, `so_ngay_nghi`, `ly_do`, `ghi_chu`, `ghi_chu_truong_phong`, `trang_thai`, `ten_nhan_vien`) VALUES
(61, 00001, '2018-10-02', '2018-10-03', 1, '1', 'Hoàn thành công việc được giao', '', '2', 'Đặng Văn'),
(63, 00001, '2018-10-03', '2018-10-03', 1, '1', 'Hoàn thành công việc được giao', '', '1', 'Đặng Văn'),
(65, 00001, '2018-10-03', '2018-10-03', 1, '1', 'Hoàn thành công việc được giao', '', '4', 'Đặng Văn'),
(66, 00002, '2018-10-03', '2018-10-04', 2, '1', 'Hoàn thành công việc được giao', '', '1', 'Thái Nguyễn Thục'),
(67, 00003, '2018-10-04', '2018-10-05', 2, '1', 'Hoàn thành công việc được giao', '', '1', 'Trương Thành'),
(69, 00001, '2018-10-03', '2018-10-04', 2, '3', 'Hoàn thành công việc được giao', 'Được phép nghỉ', '3', 'Đặng Văn'),
(73, 00002, '2018-10-02', '2018-10-03', 2, '3', 'Hoàn thành công việc được giao', 'Được phép nghỉ', '3', 'Thái Nguyễn Thục'),
(75, 00003, '2018-10-02', '2018-10-04', 3, '1', 'Hoàn thành công việc được giao', 'Được phép nghỉ', '3', 'Trương Thành'),
(76, 00004, '2018-10-03', '2018-10-05', 3, '1', 'Hoàn thành công việc được giao', 'Được phép nghỉ', '3', 'Hoàng Phi'),
(77, 00003, '2018-10-05', '2018-10-08', 2, '1', 'Hoàn thành công việc được giao', 'Được phép nghỉ', '3', 'Trương Thành'),
(78, 00005, '2018-10-02', '2018-10-05', 4, '1', 'Hoàn thành công việc được giao', '', '2', 'Đoàn Thị');
...
INSERT INTO `trang_thai` (`id`, `ma_trang_thai`, `trang_thai`) VALUES
(1, 1, 'Nháp'),
(2, 2, 'Chờ duyệt'),
(3, 3, 'Duyệt'),
(4, 4, 'Từ chối\r\n'),
...
--
-- Indexes for table `ffse1703004_users`
--
ALTER TABLE `ffse1703004_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `ly_do_xin_nghi`
--
ALTER TABLE `ly_do_xin_nghi`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `ngay_nghi`
--
...
--
-- Indexes for table `thong_ke_don_xin_phep`
--
ALTER TABLE `thong_ke_don_xin_phep`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ffse1703004_users`
--
ALTER TABLE `ffse1703004_users`
...
--
-- AUTO_INCREMENT for table `ly_do_xin_nghi`
--
ALTER TABLE `ly_do_xin_nghi`
...
--
-- AUTO_INCREMENT for table `thong_ke_don_xin_phep`
--
ALTER TABLE `thong_ke_don_xin_phep`
